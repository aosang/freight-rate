...
<script>
	export default {
		...
		onLoad(options) {
			...
			// this.url = 'https://www.pandalogqd.com/index/index/fclindex?priceId=' + this.priceId + '&priceType=' + this.priceType + '&tokenId=' + this.tokenId
			this.url = 'https://wxa.worldjaguar.com/webviewfcl?priceId=' + this.priceId + '&priceType=' + this.priceType + '&tokenId=' + this.tokenId
		},
