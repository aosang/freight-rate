	...
	<view class="profile">
			...
			<view class="profile-box-l" v-else>				
				<view class="profile-avatar">
					...
					<view class="profile-user">
						...
						<tetx class="profile-phone">
							{{unserphone}}
							<text style="margin-left: 10rpx">{{countryArea? countryArea : '--'}}</text>	
						</tetx>
						<tetx class="profile-phone">{{useremail? useremail : '--'}}</tetx>
					</view>
				</view>
		...
		<view class="profile-list">
			...
			<view class="profile-item" @click="openContactInfo">
				...
				<uni-popup ref="contactInfo" type="top" background-color="#fff">
					<view class="contact-box">
						...
						<view class="contact-item">
							<text><text class="iconfont icon-phone1"></text>{{$t('profile.phone')}}&nbsp;0532-68607931</text>
						</view>
						<view class="contact-item">
							<text><text class="iconfont icon-email-fill"></text>{{$t('profile.email')}}&nbsp;lclservice@wplx.com</text>
						</view>
						<view class="contact-item">
			...
			<view class="profile-item">
				...
				<text style="margin: 0 0 0 auto">1.0.89</text>
			</view>
			
			<view class="profile-item">
				<view class="iconfont icon-namecard" style="color: #32a6fd"></view>
				<text>{{$t('profile.registered')}}</text>
				<text style="margin: 0 0 0 auto">鲁ICP备19056877号-2X</text>
			</view>
		</view>
	</view>
</template>
...
.profile-list {
	...
	.profile-item {
		...
		.icon-history, .icon-language, .icon-rejected-order, .icon-color, .icon-set, .icon-namecard, .icon-listing-content-fill {
			font-size: 44rpx;
			margin-right: 20rpx;
		}
