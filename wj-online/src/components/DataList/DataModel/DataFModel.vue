<template>
  <div class="DataModel">
    <el-dialog width="83%" title="海出整箱报价单" :visible.sync="isShow" :close-on-click-modal="false" @close="clearHistory">
      <div class="model-info-city">
        ...
        <div class="city-item">
          <label>{{ lclInfo.F_Voyage ? lclInfo.F_Voyage : '--' }}天</label>
          <i></i>
          <label>{{ lclInfo.TransitPortEnglish? lclInfo.TransitPortEnglish : '直达'}}</label>
        </div>
        <div class="city-item">
      ...
      <div class="model-info-detail">
        <div class="detail-group">
          <div class="detail-item" v-if="lclInfo.FromQuayEng || lclInfo.FromQuayName">
            <span>起运港码头</span>
            <p>{{lclInfo.FromQuayEng? lclInfo.FromQuayEng : ''}}{{ lclInfo.FromQuayName? lclInfo.FromQuayName : '' }}</p>
          </div>
          <div class="detail-item" v-if="lclInfo.F_DesPortQuayId">
            <span>目的港码头</span>
      ...
      <el-tabs v-model="activeName" class="model-tabs">
        ...
        <el-tab-pane label="制作报价单" name="2">
          ...
          <div style="margin: 20px 0">
            <el-alert :closable="false" show-icon type="warning" title="蓝色字体的表示该条费用为单票费用"></el-alert>
          </div>
          ...
          <div class="model-create-table">
            <div class="table-fee-item">
              <div class="fee-info">
                ...
                <span>单票费用：{{singlePriceFreight}}</span>
              </div>
              <div class="order-table">
                ...
                >
                  <el-table-column label="费用名称">
                    <template slot-scope="scope">
                      <span :class="scope.row.F_SingleVote? 'singleColor' : ''">{{ scope.row.F_ExpenseCodeName}}</span>
                    </template>
                  </el-table-column>
                  ...
                  <el-table-column label="40NOR/数量">
                    <template slot-scope="scope">
                      <span v-show="scope.row.isInput" :class="scope.row.F_SingleVote? 'singleColor' : ''">
                ...
                <div class="order-edit">
                  <ul>
                    <li>
                      <el-input 
                        v-model="addFee.F_ExpenseCodeName" 
                        placeholder="费用名称"
                      >
                      </el-input>
                    </li>
            ...
            <div class="table-fee-item">
              <div class="fee-info">
                ...
                <span>单票费用：{{singlePricePol? singlePricePol : '-'}}</span>
              </div>
              <div class="order-table">
                <el-table 
                  style="width: 100%" 
                ...
                <div class="order-edit">
                  <ul>
                    <li>
                      <el-input 
                        v-model="addPolFee.F_ExpenseCodeName" 
                        placeholder="费用名称">
                      </el-input>
                    </li>
                    <li>
            ...
            <div class="table-fee-item">
              <div class="fee-info">
                ...
                <span>单票费用：{{singlePricePod? singlePricePod : '-'}}</span>
              </div>
              <div class="order-table">
                <el-table 
                  style="width: 100%" 
                ...
                <div class="order-edit">
                  <ul>
                    <li>
                      <el-input 
                        v-model="addPodFee.F_ExpenseCodeName" 
                        placeholder="费用名称">
                      </el-input>
                    </li>
                    <li>
...
export default {
  ...
  methods: {
    ...
    addFeeList(type) {
      if (type == 1) {
        const { F_ExpenseCodeName, F_Currency} = this.addFee
        if (F_ExpenseCodeName.trim() == '' || F_Currency == '') {
          this.$message({
            message: '请填写正确海运费！',
            type: 'error',
            duration: 2000
        ...
        const { F_ExpenseCodeName, F_Currency} = this.addPolFee
        if (F_ExpenseCodeName.trim() == '' || F_Currency == '') {
          this.$message({
            message: '请填写正确起运港费！',
            type: 'error',
        ...
        const { F_ExpenseCodeName, F_Currency } = this.addPodFee
        if (F_ExpenseCodeName.trim() == '' || F_Currency == '') {
          this.$message({
            message: '请填写正确目的港费！',
            type: 'error',
