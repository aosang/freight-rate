      ...
      <table>
        ...
        <tbody>
          <tr v-for="d in lcldata" :key="d.F_Id">
            ...
            <td>
              <div class="lcl-pay">
                <el-popover placement="left" width="1000" title="起运港">
                  ...
                  <el-table
                    ...
                    <el-table-column width="60" prop="F_UnitPrice" label="单价"></el-table-column>
                    <el-table-column width="120" prop="F_Unit" label="单位"></el-table-column>
                ...
                <el-popover placement="left" width="1000" title="目的港">
                  ...
                  <el-table
                    ...
                    <el-table-column prop="F_ExpenseCodeName" label="费用名称">
                      <template slot-scope="scope">
                        {{scope.row.F_ExpenseCodeName}} {{'('+scope.row.F_ExpenseCodeEng+')'}}
                      </template>
                    </el-table-column>
                    ...
                    <el-table-column label="备注">
                      <template slot-scope="scope">
                        ...
                        >
                          ...
                          <el-button size="mini" style="background: #0081ff">详情</el-button>
                        </el-tooltip>
                        <div v-else>-</div>
                      </template>
                    </el-table-column>
