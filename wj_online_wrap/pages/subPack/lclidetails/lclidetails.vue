	...
	<view class="root">
		<view class="lcldetails">
			...
			<view class="lcldetails-info">
				<text>{{$t('lcllist.etd')}}{{applicationLocal == 'zh-Hans'? lclInfo.F_ShiftPeriod? lclInfo.F_ShiftPeriod : '--' : lclInfo.F_ShiftPeriodEn? lclInfo.F_ShiftPeriodEn : '--'}}</text>
				<text>{{$t('lcldetail.si')}}{{applicationLocal == 'zh-Hans'? lclInfo.F_CutoffPeriod? lclInfo.F_CutoffPeriod: '--' : lclInfo.F_CutoffPeriodEn? lclInfo.F_CutoffPeriodEn : '--'}}</text>
