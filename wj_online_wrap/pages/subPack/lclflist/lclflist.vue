				...
				<view class="lcllist-top">
					<view class="type">
						<text class="type-label">
							<text>{{applicationLocal == 'zh-Hans'? lcl.F_SpellState === '1'? '直达' : '中转' : lcl.F_SpellState === '1'? 'Direct' : 'Transfer'}}</text>
						...
						<text class="type-info">{{applicationLocal == 'zh-Hans'? lcl.ConsigneeTypeName : lcl.F_ConsigneeType}}</text>
					</view>
					<view class="city">
					...
					<view class="info">
						...
						>
							班期：{{applicationLocal == 'zh-Hans'? lcl.F_ShiftPeriod : lcl.F_ShiftPeriod}}
						</text>
						<text class="info-day">
					...
					<view class="info">
						<text class="info-week">
							舱位：{{applicationLocal == 'zh-Hans'? lcl.F_ShippingSpace : lcl.F_ShippingSpace}}
						</text>
