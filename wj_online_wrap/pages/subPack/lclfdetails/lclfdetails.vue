	...
	<view class="root">
		<view class="lcldetails">
			...
			<view class="lcldetails-info">
				<text>
					班期：{{applicationLocal == 'zh-Hans'? lclInfo.F_ShiftPeriod? lclInfo.F_ShiftPeriod : '--' : lclInfo.F_ShiftPeriodEn? lclInfo.F_ShiftPeriodEn : '--'}}
				</text>
				<text>
					箱属：{{lclInfo.F_Ceratina? lclInfo.F_Ceratina : '--'}}
				</text>
				<text>
					截关期：{{applicationLocal == 'zh-Hans'? lclInfo.F_CutoffTime? lclInfo.F_CutoffTime: '--' : lclInfo.F_CutoffTimeEn? lclInfo.F_CutoffTimeEn : '--'}}
				</text>
				<text>
					开航日：{{applicationLocal == 'zh-Hans'? lclInfo.F_CutoffGoodsTime? lclInfo.F_CutoffGoodsTime : '--'  : lclInfo.F_CutoffGoodsTimeEn? lclInfo.F_CutoffGoodsTimeEn : '--'}}
				</text>
				<text>
