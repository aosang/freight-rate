<template>
	<view class="landList">
		<view class="lcllist-box">
			<view class="lclList-empty" v-if="landData.length == 0">
			...
			>
				<view class="lcllist-top">
					<view class="type">
						<text class="type-label">Postcode：{{land.F_PostCode}}</text>
						<text class="type-weight">T/T:{{land.F_AgingDay? land.F_AgingDay + 'Day' : '--'}}</text>
					</view>
					<view class="city">
						<text class="city-start">{{land.AreaText}}</text>
						<text class="iconfont icon-double-arro-right"></text>
						<text class="city-end">{{land.FromPortEnglish}}</text>
					</view>
				</view>
				<view class="lcllist-bottom">
					<view class="number">
						<view class="number-item">
							...
							<text class="number-unit">Basic Freight</text>
						</view>
						<view class="number-item">
							<text class="number-text" v-if="isLogin !== null">
							...
							<text class="number-text" v-else>***</text>
							<text class="number-unit">Delivery Charge</text>
						</view>
						<view class="number-item">
							<text class="number-text" v-if="isLogin !== null">
							...
							<text class="number-text" v-else>***</text>
							<text class="number-unit">Total</text>
						</view>
					</view>
					<view class="date">
