<template>
  <div class="Lcl-List">
        ...
        <div class="Search-item">
          ...
          <div class="Lcl-input">
            ...
            <el-select 
              ...
              remote
              clearable
              placeholder="Please Enter POL Country/Region"
    ...
    <Type-Tag :bgColor="bgColor">
      <div slot="slot-text">Import-LCL</div>
    </Type-Tag>
  </div>
</template>
...
export default {
  ...
  created() {
    ...
    this.isearchText = this.$route.params.isearchText

    // 调用港口列表
    this.getPolListData(this.isearchText, 2)
    this.getPodListData(_, 2)
