<template>
  <div class="MyOrder">
    ...
    <el-card class="order-card">
      <el-tag type="success" style="margin-right: 20px">Import-LCL</el-tag>
      <el-date-picker 
        v-model="startTime" 
        type="date" 
    ...
    <el-card class="order-card">
      ...
      >
        ...
        <el-table-column min-width="80" label="Business type">
          <template slot-scope="scope">
        ...
        <el-table-column min-width="150" label="Carrier">
          <template slot-scope="scope">
        ...
        <el-table-column min-width="150" label="Number">
          <template slot-scope="scope">
            {{ scope.row.F_PCSQuantity }}{{ scope.row.F_PCSUnit === '1' ? 'PKG(S)' : 'PLT(S)' }}/{{ scope.row.F_GrossWeight + 'KGS' }}/{{ scope.row.F_Volume + 'CBM' }}
          </template>
        </el-table-column>
        <el-table-column min-width="80" prop="F_CreateUserName" label="Offeror"></el-table-column>
        ...
        <el-table-column min-width="80" prop="CustomerName" label="Contact"></el-table-column>
      </el-table>
      <!-- 分页 -->
